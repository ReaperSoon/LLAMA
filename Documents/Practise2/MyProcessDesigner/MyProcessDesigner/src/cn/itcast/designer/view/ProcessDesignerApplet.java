 ...
 * @author tyg
 */
public class ProcessDesignerApplet extends JApplet implements MainFrame{
...
//            SwingUtilities.updateComponentTreeUI(this);
    ...
    private void btnSelectMousePressed(java.awt.event.MouseEvent evt) {
        getDesignerPanel().setFuncType(FuncType.SELECT);
        setToggleButtonsStatus(btnSelect, false);
    }

    private void jToggleButton2MousePressed(java.awt.event.MouseEvent evt) {
        getDesignerPanel().setFuncType(FuncType.PROCESS_TRANSITION);
        setToggleButtonsStatus(jToggleButton2, false);
    }

    private void jToggleButton3MousePressed(java.awt.event.MouseEvent evt) {
        getDesignerPanel().setFuncType(FuncType.PROCESS_NODE_TASK);
        setToggleButtonsStatus(jToggleButton3, false);
    }

    private void jToggleButton4MousePressed(java.awt.event.MouseEvent evt) {
        getDesignerPanel().setFuncType(FuncType.PROCESS_NODE_START);
        setToggleButtonsStatus(jToggleButton4, false);
    }

    private void jToggleButton5MousePressed(java.awt.event.MouseEvent evt) {
    ...
    private void jButton2MousePressed(java.awt.event.MouseEvent evt) {
        ...
        jFileChooser.setDialogTitle("请选择文件保存的路径");
        // jFileChooser.setDialogType(JFileChooser.CUSTOM_DIALOG); // 设置为保存类型的对话框
        jFileChooser.setFileFilter(new FileNameExtensionFilter("流程定义文档（*.zip）", "zip"));
    ...
    private void btnPropertiesMousePressed(java.awt.event.MouseEvent evt) {
        // 当前要配置的元素
