...
import fr.llama.server.database.Database;
...
public class ServicesLoader extends Thread implements javax.servlet.ServletContextListener {
	...
	public void loadServices() {
		boolean databaseInitialized = connectDatabase();
	...
	public boolean connectDatabase() {
		while (!Database.getInstance().initialize()) {
			Logger.log(Logger.ERROR, "Database connexion fail!");
			try {
				Thread.sleep(5000);
