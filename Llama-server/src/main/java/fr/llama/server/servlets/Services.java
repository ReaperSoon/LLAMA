package fr.llama.server.servlets;
...
import fr.llama.server.rpc.RpcObject;
import fr.llama.server.rpc.ServiceException;
import fr.llama.server.rpc.ServicesLoader;
import fr.llama.server.services.AbstractService;
...
public class Services extends HttpServlet implements javax.servlet.ServletContextListener {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<h1>What are you looking for ?</h1>");
		out.println("<img src=\"http://stevecohen.fr/homer_lounging.gif\">");
	}
